...
file.seek(0)
time_s = file[1]
ref_time = time_s.julianDay
print_time_s = time_s.analDate
...
for nama in listfile:
    ...
    cur_time = time.julianDay #waktu forecast saat ini
    print_time = time.analDate
    time_step = (cur_time - ref_time) * 24
    time_step *= 60 #forecast time sekian menit dari waktu data analisis
    print("memproses data MSLP tanggal ",print_time,"...")
    fidp.write('TIME             =   {0}  minutes since {1} +00:00\n'.format(time_step,print_time_s))
...
for nama in listfile:
    ...
    time_step = (cur_time - ref_time) * 24
    time_step *= 60 #forecast time sekian menit dari waktu data analisis
    print("memproses data angin U tanggal ",print_time,"...")
...
for nama in listfile:
    ...
    time_step = (cur_time - ref_time) * 24
    time_step *= 60 #forecast time sekian menit dari waktu data analisis
    print("memproses data angin V tanggal ",print_time,"...")
